...
class LanguageModel(nn.Module):
    ...
    def from_pretrained(cls, cfg):
        ...
        cfg.lm_rms_eps = getattr(hf_config, "rms_norm_eps", cfg.lm_rms_eps)

        # Newer/alternative HF configs may store rope theta inside rope_scaling.
        ...
        cfg.lm_n_kv_heads = getattr(hf_config, "num_key_value_heads", cfg.lm_n_heads)
        cfg.lm_dropout = getattr(hf_config, "attention_dropout", cfg.lm_dropout)
